...
Route::get('/resesarches', [PageController::class, 'researches']);
Route::get('/tools', [PageController::class, 'tools']);
Route::get('/login', [PageController::class, 'login']);
Route::get('/create-account', [PageController::class, 'create_account']);
Route::get('/account', [PageController::class, 'account']);
Route::get('/get-password-reset-link', [PageController::class, 'get_password_reset_link']);
